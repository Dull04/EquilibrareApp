...
class EditNoteFragment : Fragment(R.layout.fragment_edit_note), MenuProvider {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val hasilAnalisisButton: Button = view.findViewById(R.id.ButtonHasilAnalisis)
        hasilAnalisisButton.setOnClickListener {
            // Start HelloWorldActivity when button is clicked
            startActivity(Intent(activity, HasilAnalisis::class.java))
        }
    }
